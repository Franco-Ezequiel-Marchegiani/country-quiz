  ...
  return (
      <section className='questionContainer'>
        ...
        <h2 className='questionText'>{flagQuestions[numberQuestion].questionText}</h2>
          ...
          <div className='btnContainer'>
                <button className={bothClassesBtn3} onClick={() => setAnswerSelected("NextQuestion")}><span className='letterOfOptionAnswer'>C</span> <span className='textAnswer'>Texto 3</span></button>
                {answerSelected !== "" ?
          ...
          <div className='btnContainer'>
                <button className={bothClassesBtn4} onClick={() => setAnswerSelected("NextQuestion")}><span className='letterOfOptionAnswer'>D</span> <span className='textAnswer'>Texto 4</span></button>
                {answerSelected !== "" ?
