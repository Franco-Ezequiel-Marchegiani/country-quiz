  ...
  return (
      <section className='questionContainer'>
        ...
        <h2 className='questionText'>{flagQuestions[numberQuestion].questionText}</h2>
          ...
          <div className='btnContainer'>
                <button className={bothClassesBtn4} onMouseOver={()=> setOnHoverBtn4(true)} onClick={() => setAnswerSelected("NextQuestion")}><span className='letterOfOptionAnswer'>D</span> <span className='textAnswer'>Texto 4</span></button>
                {answerSelected !== "" ?
